...
@posts_bp.post('/post/<int:post_id>/comments/<int:comment_id>/edit')
...
@posts_bp.post('/post/<int:post_id>/comments/<int:comment_id>/delete')
...
@posts_bp.post('/post/<int:post_id>/like')
